  ...
  <div className='py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip'>
    ...
    <HeroOrbit size={430} rotation={-14} shouldOrbit orbitDuration='30s' shouldSpin spinDuration='3s'>
      ...
      <HeroOrbit size={520} rotation={-41} shouldOrbit orbitDuration='34s' shouldSpin spinDuration='6s'>
          {/* always remember that rounded-full is a cricle */}
    ...
    <div className="container">
      ...
      <div className='flex flex-col md:flex-row justify-center items-center mt-8 gap-4 relative'>
        <Link href={'#project'} className='inline-flex items-center gap-2 border border-white/15 px-6 h-12 rounded-xl'>
          <span className='font-semibold cursor-pointer'>Explore My Work</span>
          <ArrowDown className='size-4'/>
        </Link>
        <Link href={'https://instagram.com/perspicacious.dev'} className='relative inline-flex items-center gap-2 border-white bg-white text-gray-900 h-12 px-6 rounded-xl cursor-pointer'>
          <span>👋</span>
